...
\begin{document}
    ...
    \begin{tablist}
  \item[2025--]   \tab United States Department of Agriculture, Agricultural Research Service \\
	 			Acting Research Leader, Genomics and Bioinformatics Research Unit\\		
				\tab \begin{itemize}
                             	\item[$\bullet$] Led a research unit providing planned animal and microbial genomic sequencing and analysis.
                                \item[$\bullet$] Ran a research group focused on software methods to advance microbiome science, digital phenotyping, and animal health.
                                
				\end{itemize}
	 \item[2023--25]   \tab United States Department of Agriculture, Agricultural Research Service \\
        ...
        \item[2017--]   \tab United States Department of Agriculture, Agricultural Research Service \\
...
\section*{Articles in Peer-Reviewed Journals and Preprints}
    \publication{foxx2025exploring}
    \publication{foxx2025cautionary}
    \publication{swientoniewski2025linear}
    \publication{gorman2025flood}
	\publication{einarsson2024itsxpress}
	\publication{page2024whole}
	\publication{franco2024micrompn}
	\publication{page2024annotated}
	\publication{ray2024effect}
	\publication{rambo2023changes}
