...
%    \item[2019] \tab  Fernandez-Baca, C., Rivers, A.R., Maul, J. ,Kim, W., McClung, A., Roberts, D., Reddy, V.,  Barnaby. J. \enquote{Rice Plant-Soil Microbiome Interactions Driven by Root and Shoot Biomass} Submitted to \textit{Applied and Environmental Microbiology}.
 %   \end{tablist}
   ...
   \section*{Intellectual property}
    ...
    \begin{tablist}
    	\item[2023 ] \tab Rivers. A.R. Ecological controls of methane emission in rice. Tsukuba Conference for Future Shapers.  Tsukuba, Japan. September 25.
    	\item[2023 ] \tab Rivers. A.R. Methane inhibitors for genetic engineering of rice. Inception Workshop on Reducing Methane Emissions in Rice. International Rice Research Institute. Los Ba\~{n}os, Philippines. July 10.
