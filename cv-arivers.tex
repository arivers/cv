...
%    \item[2019] \tab  Fernandez-Baca, C., Rivers, A.R., Maul, J. ,Kim, W., McClung, A., Roberts, D., Reddy, V.,  Barnaby. J. \enquote{Rice Plant-Soil Microbiome Interactions Driven by Root and Shoot Biomass} Submitted to \textit{Applied and Environmental Microbiology}.
 %   \end{tablist}
    ...
    \begin{tablist}
    	\item[2022] \tab Xenosurveillance of flies in wet markets to monitor for the emergence and spillover potential of viral, bacterial, and parasitic pathogens. (\$431,085). ARS Geospatial and Environmental Epidemiology panel. PI.
